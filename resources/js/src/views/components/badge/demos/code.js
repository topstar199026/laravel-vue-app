...
<template>
  <div class="demo-space-x">
    ...
    >
      <v-avatar>
        <v-img :src="require('@/assets/images/avatars/avatar-8.png').default"></v-img>
      </v-avatar>
    </v-badge>
  </div>
</template>
...
<template>
  <div class="demo-space-x">
    ...
    >
      <v-avatar large>
        <v-img :src="require('@/assets/images/avatars/avatar-7.png').default"></v-img>
      </v-avatar>
    </v-badge>
    ...
    >
      <v-avatar large>
        <v-img :src="require('@/assets/images/avatars/avatar-6.png').default"></v-img>
      </v-avatar>
    </v-badge>
    ...
    >
      <v-avatar large>
        <v-img :src="require('@/assets/images/avatars/avatar-5.png').default"></v-img>
      </v-avatar>
    </v-badge>
  </div>
</template>
