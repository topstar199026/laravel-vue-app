    ...
    <v-card-text>
      <v-row>
        <v-col cols="12" sm="7" class="total-profit-chart-col">
          <v-card-title class="px-0 pt-0"> Total Profit </v-card-title>
          <vue-apex-charts
        ...
        <v-col cols="12" sm="5">
          <v-card elevation="0">
            ...
            <v-card-title class="align-start pt-0 flex-nowrap">
              ...
              <v-spacer></v-spacer>
              <v-btn icon small class="me-n7 mt-n1">
                <v-icon size="22">
            ...
            <v-card-text class="pb-0 pt-5">
              ...
              <v-list two-line subheader>
                ...
                <v-list-item class="pa-0">
                  ...
                  <v-list-item-content>
                    <v-list-item-title class="font-weight-semibold"> $48,568.20 </v-list-item-title>
                    <v-list-item-subtitle>Total Profit</v-list-item-subtitle>
                  </v-list-item-content>
                </v-list-item>
                <!-- List Item: Income -->
                <v-list-item class="pa-0">
                  <v-list-item-avatar class="v-avatar-light-bg primary--text justify-center" size="40" rounded>
                    <v-icon size="30" color="primary">
                      {{ icons.mdiCurrencyUsd }}
                    </v-icon>
                  </v-list-item-avatar>
                  <v-list-item-content>
                    <v-list-item-title class="font-weight-semibold"> $38,453.25 </v-list-item-title>
                ...
                <v-list-item class="pa-0">
                  ...
                  <v-list-item-content>
                    <v-list-item-title class="font-weight-semibold"> $2,453.45 </v-list-item-title>
