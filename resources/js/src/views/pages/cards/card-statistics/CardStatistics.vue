...
export default {
  ...
  setup() {
    ...
    const ratingsOptions = {
      ...
      chipColor: 'primary',
      avatar: require('@/assets/images/avatars/avatar-9.png').default,
      avatarWidth: '112',
    }
    ...
    const sessionsOptions = {
      ...
      chipText: 'Last Week',
      chipColor: 'secondary',
      avatar: require('@/assets/images/avatars/avatar-10.png').default,
      avatarWidth: '86',
    }
    ...
    const customersOptions = {
      ...
      chipColor: 'info',
      avatar: require('@/assets/images/avatars/avatar-11.png').default,
      avatarWidth: '88',
    }
    ...
    const totalOrders = {
      ...
      chipText: 'Last Month',
      chipColor: 'warning',
      avatar: require('@/assets/images/avatars/avatar-12.png').default,
      avatarWidth: '73',
    }
