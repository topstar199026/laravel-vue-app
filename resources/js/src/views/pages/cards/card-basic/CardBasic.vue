  ...
  <div>
    <v-row>
      ...
      <v-col md="4" sm="6" cols="12">
        <v-card>
          <v-img :src="require('@/assets/images/pages/page-1.png').default" height="250" />
      ...
      <v-col md="4" sm="6" cols="12">
        <v-card>
          <v-img
            ...
            :src="require('@/assets/images/pages/page-2.png').default"
            height="250"
          />
          <v-card-text class="position-relative">
            <!-- User Avatar -->
            <v-avatar size="60" color="white" class="avatar-center">
              <v-img :src="require('@/assets/images/avatars/avatar-1.png').default"></v-img>
            </v-avatar>
            ...
            <div class="d-flex justify-space-between align-center mt-8">
              ...
              <div class="v-avatar-group" :class="rootThemeClasses">
                ...
                <v-avatar size="40">
                  <v-img :src="require('@/assets/images/avatars/avatar-2.png').default"></v-img>
                </v-avatar>
                <v-avatar size="40">
                  <v-img :src="require('@/assets/images/avatars/avatar-3.png').default"></v-img>
                </v-avatar>
                <v-avatar size="40">
                  <v-img :src="require('@/assets/images/avatars/avatar-4.png').default"></v-img>
                </v-avatar>
              </div>
            </div>
          </v-card-text>
      ...
      <v-col md="4" sm="6" cols="12" class="align-self-start">
        <v-card>
          <v-img :src="require('@/assets/images/pages/page-3.png').default" height="250"></v-img>
      ...
      <v-col sm="6" cols="12">
        <v-card class="d-flex align-center">
          <div class="d-flex justify-space-between flex-wrap flex-md-nowrap flex-column flex-md-row">
            <div class="mx-auto">
              <v-img width="220" height="100%" :src="require('@/assets/images/eCommerce/2.png').default"></v-img>
            </div>
      ...
      <v-col sm="6" cols="12">
        <v-card>
          <div class="d-flex flex-column-reverse flex-md-row">
            ...
            <div class="pa-4">
              <v-img
                :src="require('@/assets/images/pages/page-5.jpg').default"
      ...
      <v-col lg="4" sm="6" cols="12" class="align-self-start">
        <v-card>
          <v-img :src="require('@/assets/images/pages/page-6.jpg').default"></v-img>
      ...
      <v-col cols="12" md="6" lg="4" class="align-self-start">
        <v-card color="text-center">
          <v-card-text class="d-flex flex-column justify-center align-center">
            <v-avatar color="primary" class="v-avatar-light-bg primary--text mt-10" icon size="50">
