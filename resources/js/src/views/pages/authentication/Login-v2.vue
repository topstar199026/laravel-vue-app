            ...
            <v-col cols="12" sm="8" md="6" lg="12" class="mx-auto">
              <v-card flat>
                ...
                <v-card-text>
                  <v-form>
                    ...
                    <div class="d-flex align-center justify-space-between flex-wrap">
                      <v-checkbox hide-details label="Remember Me" class="me-3 mt-1"> </v-checkbox>

                      <!-- forget link -->
                      <router-link :to="{ name: 'auth-forgot-password-v2' }" class="mt-1">
                        Forgot Password?
                      </router-link>
                    </div>

                    <v-btn block class="mt-6" color="primary"> Login </v-btn>
                  </v-form>
                </v-card-text>
                ...
                <v-card-text class="d-flex align-center justify-center flex-wrap mt-2">
                  ...
                  <router-link :to="{ name: 'auth-register-v2' }"> Create an account </router-link>
                </v-card-text>
