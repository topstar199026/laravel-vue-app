      ...
      <v-row>
        <v-col cols="12" md="6" sm="8" class="mx-auto">
          ...
          <div class="d-flex align-center justify-center">
            ...
            <v-switch v-model="status" value="annually" class="mx-3"></v-switch>
      ...
      <v-row>
        <v-col offset-sm="2" sm="8" md="12" offset-lg="2" lg="10" class="mx-auto">
          <v-row>
              ...
              <v-card outlined class="text-center">
                <v-card-text>
                  ...
                  <div class="d-flex justify-center">
                    <img :src="pricing.basicPlan.imgSrc" class="mx-auto mt-3" />
                  </div>
                  ...
                  <div class="annual-plan">
                    ...
                    <small v-if="status" class="annual-pricing"
            ...
            <!-- standard -->
            <v-col cols="12" md="4">
              <v-card outlined class="popular text-center">
                <v-card-text>
                  <!-- chip -->
                  <div v-show="pricing.standardPlan.popularPlan" class="pricing-badge text-right mt-n3">
                  ...
                  <!-- image -->
                  <div class="d-flex justify-center">
                    <img :src="pricing.standardPlan.imgSrc" class="mx-auto" />
                  </div>
                ...
                <v-card-text>
                  ...
                  <!-- plan button -->
                  <v-btn block color="primary"> Upgrade </v-btn>
                </v-card-text>
              </v-card>
            </v-col>
            ...
            <v-col cols="12" md="4">
              <v-card outlined class="text-center">
                <v-card-text>
                  <!-- image -->
                  <div class="d-flex justify-center">
                    <img :src="pricing.enterprisePlan.imgSrc" class="mx-auto mb-3" />
                  </div>
                ...
                <v-card-text>
                  ...
                  <!-- plan button -->
                  <v-btn outlined block color="primary"> Upgrade </v-btn>
                </v-card-text>
              </v-card>
            </v-col>
          </v-row>
  ...
  setup() {
    ...
    const pricing = {
      basicPlan: {
        ...
        imgSrc: require('@/assets/images/misc/pricing-tree-1.png').default,
        yearlyPlan: {
          perMonth: 0,
          totalAnnual: 0,
        },
      ...
      standardPlan: {
        ...
        imgSrc: require('@/assets/images/misc/pricing-tree-2.png').default,
        yearlyPlan: {
          perMonth: 40,
          totalAnnual: 480,
        },
      ...
      enterprisePlan: {
        ...
        imgSrc: require('@/assets/images/misc/pricing-tree-3.png').default,
        yearlyPlan: {
          perMonth: 80,
          totalAnnual: 960,
        },
