  ...
  <v-card>
    ...
    <v-card-text>
      ...
      <div class="payment-details">
        ...
        <p class="text-xs primary--text font-weight-medium mt-2 mb-1">Add Payment Method</p>
      </div>

      <v-text-field outlined placeholder="Email Address" class="mb-4" dense hide-details></v-text-field>
