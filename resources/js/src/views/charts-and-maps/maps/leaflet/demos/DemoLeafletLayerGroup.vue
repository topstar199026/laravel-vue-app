<template>
  <div>
    <v-card-text>
      <v-btn color="primary" outlined @click="fitPolyline"> Fit map to polyline </v-btn>

      <v-row class="mt-2">
        <v-col cols="12" md="6">
          <v-select v-model="layersPosition" :items="Positions" outlined dense label="Contol Layers position" />
        </v-col>
        <v-col cols="12" md="6">
          <v-select v-model="attributionPosition" label="Attribution position" :items="Positions" outlined dense />
        </v-col>
      </v-row>
    </v-card-text>
