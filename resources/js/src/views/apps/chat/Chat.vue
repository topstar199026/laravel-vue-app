<template>
  <v-card class="max-h-content-container app-chat position-relative overflow-hidden text-sm">
    ...
    <div class="chat-content-area h-full d-flex flex-column" :style="contentStyles">
      <!-- Active Chat -->
      <div v-if="activeChat.contact" class="h-full">
        <!-- Navbar -->
        <div class="d-flex align-center justify-space-between px-5 py-4" style="height: 72px">
          ...
          <div class="d-flex align-center">
            ...
            >
              ...
              >
                <v-img v-if="activeChat.contact.avatar" :src="activeChat.contact.avatar"></v-img>
        ...
        <perfect-scrollbar ref="refChatLogPS" :options="perfectScrollbarOptions" class="ps-chat-log h-full">
          <chat-log :chat-data="activeChat" :profile-user-avatar="profileUserDataMinimal.avatar"></chat-log>
        </perfect-scrollbar>
        ...
        <v-form autocomplete="off" @submit.prevent="sendMessage">
          ...
          >
            <template #append>
              ...
              <v-btn color="primary" elevation="0" type="submit" :icon="$vuetify.breakpoint.xsOnly">
                <template v-if="$vuetify.breakpoint.smAndUp"> Send </template>
                <template v-else>
