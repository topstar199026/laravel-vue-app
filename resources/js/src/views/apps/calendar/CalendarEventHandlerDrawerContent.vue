...
export default {
  ...
  setup(props, { emit }) {
    ...
    const guestsOptions = [
      { avatar: require('@/assets/images/avatars/avatar-1.png').default, name: 'Jane Foster' },
      { avatar: require('@/assets/images/avatars/avatar-3.png').default, name: 'Donna Frank' },
      { avatar: require('@/assets/images/avatars/avatar-5.png').default, name: 'Gabrielle Robertson' },
      { avatar: require('@/assets/images/avatars/avatar-7.png').default, name: 'Lori Spears' },
      { avatar: require('@/assets/images/avatars/avatar-6.png').default, name: 'Sandy Vega' },
      { avatar: require('@/assets/images/avatars/avatar-2.png').default, name: 'Cheryl May' },
    ]
