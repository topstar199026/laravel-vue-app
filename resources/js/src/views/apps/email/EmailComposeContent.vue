    ...
    <v-form>
      ...
      >
        ...
        <template #append-outer>
          <v-btn icon small @click="shallShowCCFIeld = !shallShowCCFIeld"> Cc </v-btn>
          <v-btn icon small class="me-6 ms-1" @click="shallShowBCCFIeld = !shallShowBCCFIeld"> Bcc </v-btn>
        </template>
      </v-combobox>
...
export default {
  ...
  setup(_, { emit }) {
    ...
    const emailToOptions = [
      { avatar: require('@/assets/images/avatars/avatar-1.png').default, name: 'Jane Foster', email: 'amiibi@he.zw' },
      {
        avatar: require('@/assets/images/avatars/avatar-3.png').default,
        name: 'Donna Frank',
        email: 'ocuejesov@riwwapop.ye',
      },
      {
      ...
      {
        avatar: require('@/assets/images/avatars/avatar-7.png').default,
        name: 'Lori Spears',
        email: 'zicsanroc@erher.mc',
      },
      {
        avatar: require('@/assets/images/avatars/avatar-2.png').default,
        name: 'Sandy Vega',
        email: 'ibuam@cimenuze.to',
      },
      {
        avatar: require('@/assets/images/avatars/avatar-4.png').default,
        name: 'Cheryl May',
        email: 'kivcuci@kagwabum.tr',
      },
    ]
