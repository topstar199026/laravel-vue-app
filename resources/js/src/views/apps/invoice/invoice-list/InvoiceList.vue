  ...
  <v-card id="invoice-list">
    ...
    <v-card-text class="d-flex align-center flex-wrap pb-0">
      <div class="d-flex align-center pb-5">
        ...
        <!-- create invoice -->
        <v-btn color="primary" class="me-3" :to="{ name: 'apps-invoice-add' }">
        ...
        <v-tooltip bottom>
          <template v-slot:activator="{ on, attrs }">
            <v-avatar
              ...
              v-on="on"
            >
              <v-icon size="18" :color="resolveInvoiceStatusVariantAndIcon(item.invoiceStatus).variant">
      ...
      <template #[`item.client`]="{ item }">
        <div class="d-flex align-center">
          ...
          >
            ...
            <span v-else class="font-weight-medium">{{ avatarText(item.client.name) }}</span>
          </v-avatar>
      ...
      <template #[`item.actions`]="{ item }">
        <div class="d-flex align-center justify-center">
          ...
          <v-menu bottom left>
            ...
            <v-list>
              <v-list-item v-for="(option, i) in actionOptions" :key="i" href="javascript:void(0)">
                <v-list-item-title>
