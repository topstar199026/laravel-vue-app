    ...
    <v-card class="mb-7">
      ...
      <v-card-text class="pb-2">
        <v-list dense class="py-0">
          <v-list-item v-for="account in connectedAccounts" :key="account.title" class="px-0">
            <v-img
              max-width="35"
              contain
              class="me-3"
              :src="require(`@/assets/images/logos/${account.img}`).default"
            ></v-img>
          ...
          >
            ...
            <div>
              ...
              <v-list-item-subtitle v-if="account.connected">
                <a :href="account.link" target="_blank" rel="nofollow" class="text-decoration-none text-truncate">
                  {{ account.username }}
                </a>
              </v-list-item-subtitle>
            ...
            <v-btn color="secondary" outlined min-width="38" class="px-0">
              <v-icon size="20">
