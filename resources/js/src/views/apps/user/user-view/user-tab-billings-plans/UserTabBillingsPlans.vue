      ...
      <v-card-text>
        <v-row>
          <v-col cols="12" md="6">
            ...
            <h4 class="font-weight-medium mb-1">Active until Dec 09, 2021</h4>
            <p>We will send you a notification upon Subscription expiration</p>

            <div class="d-flex align-center">
              <h4 class="font-weight-medium me-2 mb-1">$99 Per Month</h4>
          ...
          <v-col cols="12" md="6">
            <v-alert color="warning" text>
              ...
              <p class="text-sm mb-0">your plan requires updates</p>
            </v-alert>
            ...
            <p class="mt-2">Your plan requires update</p>
          </v-col>
          ...
          <v-col cols="12" class="d-flex align-center flex-wrap">
            ...
            <v-btn color="error" outlined class="mb-3 mb-sm-0"> Cancel Subscription </v-btn>
          </v-col>
        </v-row>
      </v-card-text>
    </v-card>
        ...
        <v-row>
            ...
            <table class="billing-address-table">
              <tr>
                <td class="billing-title">
                  <p class="text-no-wrap text--primary font-weight-medium">Company Name:</p>
                </td>
                <td>
              ...
              <tr>
                <td class="billing-title">
                  <p class="text-no-wrap text--primary font-weight-medium">Tax ID:</p>
                </td>
                <td>
                  <p>{{ currentBillingAddress.taxID }}</p>
                </td>
              </tr>
              <tr>
                <td class="billing-title">
                  <p class="text-no-wrap text--primary font-weight-medium">VAT Number:</p>
                </td>
                <td>
                  <p>{{ currentBillingAddress.vatNumber }}</p>
                </td>
              </tr>
              <tr>
                <td class="billing-title">
                  <p class="text-no-wrap text--primary font-weight-medium mb-0">Billing Address:</p>
                </td>
                <td>
                  <p class="mb-0">
          ...
          <v-col cols="12" lg="6">
            <table class="billing-address-table">
              <tr>
                <td class="billing-title">
                  <p class="text-no-wrap text--primary font-weight-medium">Contact:</p>
                </td>
                <td>
