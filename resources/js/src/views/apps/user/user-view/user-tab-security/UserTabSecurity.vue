<template>
  <div class="user-tab-security">
      ...
      <v-card-text>
        <div>
          ...
          <div class="d-flex align-center justify-space-between">
            ...
            <div>
              <v-btn icon small color="secondary" @click="istwoFactorDialogOpen = !istwoFactorDialogOpen">
                <v-icon size="20">
        ...
        <p class="mb-0 mt-4">
          ...
          password to log in. <a href="javascript:void(0)" class="text-decoration-none">Learn more</a>.
        </p>
      </v-card-text>
    </v-card>
    ...
    <v-card>
      ...
      <v-data-table :headers="tableColumnHeaders" :items="recenntDevices" hide-default-footer class="text-no-wrap">
        <template #[`item.browser`]="{ item }">
          <div class="d-flex align-center">
            <v-avatar size="22" class="me-2">
              <v-img :src="require(`@/assets/images/logos/${item.browser}`).default"></v-img>
            </v-avatar>
